                    ...
                    <div className='w-full flex flex-col gap-y-5'>
                        {dataProduct.map((item, index) => (
                            <div key={item.id} className='bg-gradient-to-l from-[#67BD5E] to-[#467840] rounded-xl p-3 flex flex-col text-white gap-y-3'>
                                <p className='text-center text-2xl font-bold'>Product #{index + 1}</p>
                                ...
                                <div className='flex w-full gap-x-3'>
                                    <Link to={`/editproduct/${item.id}`} className='w-1/2 bg-white p-3 text-black rounded-lg text-center'>
