        ...
        <div className="bg-gradient-to-l from-[#67BD5E] to-[#467840] p-3 flex flex-col gap-y-10 min-h-screen">
            <aside className="p-3">
                <header className="flex justify-between items-center">
                    ...
                    <button className="bg-red-700 p-3 rounded-xl text-white" onClick={handleLogout}>Logout</button>
                </header>

                {/* Sidebar for Mobile Device and Tablet Device */}
                {isOpen && (
                    <nav className="min-h-screen flex flex-col bg-ejp justify-center items-center mt-10 gap-y-10">
